...
import com.yeohe.kiosk.utils.StatusSQLUtils;
import com.yeohe.kiosk.utils.TheNetworkStatuUtils;
...
import com.yeohe.kiosk.widgets.XListView;
...
public class OrMyListViewDao implements XListView.IXListViewListener {
    ...
    public void httsData(String url) {
        ...
        phonePams.put("token", Constants.token);
...
//            mHandlers.sendEmptyMessage(2);
    ...
    public void deletecData() {
        ...
        try {
            StatusSQLUtils statusSQLUtils = new StatusSQLUtils(AppApplication.getContext());
