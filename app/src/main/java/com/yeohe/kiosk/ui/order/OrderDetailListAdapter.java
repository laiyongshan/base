...
import com.yeohe.kiosk.bean.Violation2;
...
public class OrderDetailListAdapter extends BaseAdapter {
    private List<Violation2> violationList;
    ...
    public OrderDetailListAdapter(Context context, List<Violation2> violationList) {
