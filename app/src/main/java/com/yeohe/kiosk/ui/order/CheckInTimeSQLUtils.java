 ...
 * 版本号保存数据库操作类
 */
public class CheckInTimeSQLUtils {

    private CheckInTimeSqlOpenHelp sqlOp;
    private static SQLiteDatabase db;
    private Context context;

    public CheckInTimeSQLUtils(Context context) {
        sqlOp = new CheckInTimeSqlOpenHelp(context);
        if (db == null)
