...
public class AnnualActivity extends BaseActivity<AnnualContract.Presenter> implements AnnualContract.View {
    ...
    private Annual annual = new Annual();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (ScreenSizeUtil.getScreenWidth(this) <= ScreenSizeUtil.getScreenHeight(this)) {
            ...
            RelativeLayout.LayoutParams linearParams = (RelativeLayout.LayoutParams) main_body_layout.getLayoutParams();
            linearParams.width = (int) (width *Constants.GOLDEN_RATIO);        // ;        // 当控件的高强制设成120象素
            main_body_layout.setLayoutParams(linearParams);
        ...
        params1.put("token", SharedPreferenceUtil.getInstance().getToken() + "");
...
* */
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.add_annual_btn:
                ...
                KeyBoardUtils.closeKeybord(carets[6], AnnualActivity.this);//关闭键盘
    ...
    public void showError(String error) {
        DialogUtil.showErrDialog(AnnualActivity.this, "网络请求错误", error);
    }
   ...
   */
    ...
    @Override
    public void showSucessDialog(final String orderCode, String paymoney) {
        sucessDialog = new SweetAlertDialog(AnnualActivity.this, SweetAlertDialog.SUCCESS_TYPE)
                .setTitleText("提交成功").showCancelButton(false).setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    @Override
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
                        navigateToPay(orderCode, annual_price_tv.getText().toString().trim());
                    }
                });
    ...
    /*跳转去支付*/
    @Override
    public void navigateToPay(String orderCode, String paymoney) {
//        ARouter.getInstance().build(RouterConstants.PAY_MOUDLE_ACTIVITY)
//                .withString("orderCode",orderCode)
//                .withInt("ordertype",3)
//                .withString("paymoney",paymoney)
//                .navigation();

        Intent intent = new Intent(AnnualActivity.this, PayActivity.class);
